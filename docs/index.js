...
<div class="d-flex overflow-scroll p-2">
  <div>
    ...
    <table class="table table-sm table-striped w-auto">
      <tr><th>Classic</th><td><a href="https://marmooo.github.io/tip-tap-notes/?url=${b}&title=${c}&composer=${d}">Tip Tap Notes</a></td></tr>
  ...
  <div>
    ...
    <table class="table table-sm table-striped w-auto">
      ...
      <tr><th>Web</th><td>${toString(h)}</td></tr>
    </table>
  </div>
  <div>
    ...
    <table class="table table-sm table-striped w-auto">
      ...
      <tr><th>Instruments</th><td><ul>${f}</ul></td></tr>
    </table>
  </div>
</div>
  `}function _detailFormatterJa(j,a){const e=`${midiDB}/${a.file}`,b=encodeURI(e),c=encodeURIComponent(toString(a.title)),d=encodeURIComponent(toString(a.composer)),g=toLicense(a.license),h=toLink(a.web,a.web),i=toDownload(a.id,e,"ja");let f="";return a.instruments.split(", ").forEach(a=>{f+=`<li>${a}</li>`}),`
<div class="d-flex overflow-scroll p-2">
  <div>
    <h5>楽譜</h5>
    <table class="table table-sm table-striped w-auto">
