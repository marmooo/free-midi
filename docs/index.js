...
<div class="row p-2">
  ...
  <div class="col-sm">
    <h5>Music Info</h5>
    <table class="table table-sm table-striped">
      <tr><th>title</th><td>${a.title}</td></tr>
      <tr><th>composer</th><td>${a.composer}</td></tr>
      <tr><th>opus</th><td>${a.opus}</td></tr>
      <tr><th>lyricist</th><td>${a.lyricist}</td></tr>
      <tr><th>instruments</th><td>${a.instruments}</td></tr>
      <tr><th>date</th><td>${a.date}</td></tr>
      <tr><th>style</th><td>${a.style}</td></tr>
      <tr><th>arranger</th><td>${a.arranger}</td></tr>
      <tr><th>source</th><td>${a.source}</td></tr>
    </table>
  </div>
  <div class="col-sm">
    <h5>File Info</h5>
    <table class="table table-sm table-striped">
      <tr><th>license</th><td>${a.license}</td></tr>
      <tr><th>download</th><td><a href="${b}">MIDI</a></td></tr>
      <tr><th>id</th><td>${a.id}</td></tr>
      <tr><th>maintainer</th><td>${a.maintainer}</td></tr>
      <tr><th>email</th><td>${a.email}</td></tr>
      <tr><th>web</th><td>${a.web}</td></tr>
    </table>
  </div>
</div>
