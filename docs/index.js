...
<div class="d-flex p-2">
  ...
  <div>
    ...
    <table class="table table-sm table-striped w-auto">
      ...
      <tr><th>Web</th><td>${toString(f)}</td></tr>
    </table>
  </div>
  <div>
  ...
  `}function _detailFormatterJa(h,a){const b=encodeURI(`${midiDB}/${a.file}`),c=encodeURIComponent(toString(a.title)),d=encodeURIComponent(toString(a.composer)),g=toLicense(a.license),f=toLink(a.web,a.web);let e="";return a.instruments.split(", ").forEach(a=>{e+=`<li>${a}</li>`}),`
<div class="d-flex p-2">
  <div>
    <h5>楽譜</h5>
    <table class="table table-sm table-striped w-auto">
