...
<div class="d-flex overflow-scroll p-2">
  ...
  `}function _detailFormatterJa(i,a){const d=`${midiDB}/${a.file}`,b=new URLSearchParams;b.set("url",d),a.title&&b.set("title",a.title),a.composer&&b.set("composer",a.composer),a.web&&b.set("web",a.web);const c=b.toString(),g=toLicense(a.license),f=toLink(a.web,a.web),h=toDownload(a.id,d,"ja");let e="";return a.instruments.split(", ").forEach(a=>{e+=`<li>${a}</li>`}),`
<div class="d-flex overflow-scroll p-2">
  <div>
    <h5>楽譜</h5>
    <table class="table table-sm table-striped w-auto">
